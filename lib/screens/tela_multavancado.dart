...
import 'package:matematica/widgets/result_boxmult.dart';
...
import '../models/db_connect6.dart';

class HomeScreenmultavancado extends StatefulWidget {
  const HomeScreenmultavancado({super.key});

  @override
  State<HomeScreenmultavancado> createState() => _HomeScreenmultavancadoState();
}

class _HomeScreenmultavancadoState extends State<HomeScreenmultavancado> {
  var db = DBconnect6();
