...
import '../models/db_connect2.dart';

class HomeScreenMedio extends StatefulWidget {
  const HomeScreenMedio({super.key});

  @override
  State<HomeScreenMedio> createState() => _HomeScreenMedioState();
}

class _HomeScreenMedioState extends State<HomeScreenMedio> {
  var db = DBconnect2();
