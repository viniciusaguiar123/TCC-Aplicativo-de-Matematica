...
import 'package:matematica/widgets/result_boxsub.dart';
...
import '../models/db_connect9.dart';

class HomeScreensubavancado extends StatefulWidget {
  const HomeScreensubavancado({super.key});

  @override
  State<HomeScreensubavancado> createState() => _HomeScreensubavancadoState();
}

class _HomeScreensubavancadoState extends State<HomeScreensubavancado> {
  var db = DBconnect9();
