...
import '../models/db_connect3.dart';

class HomeScreenAvancado extends StatefulWidget {
  const HomeScreenAvancado({super.key});

  @override
  State<HomeScreenAvancado> createState() => _HomeScreenAvancadoState();
}

class _HomeScreenAvancadoState extends State<HomeScreenAvancado> {
  var db = DBconnect3();
