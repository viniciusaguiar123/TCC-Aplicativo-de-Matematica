...
import '../models/db_connect4.dart';

class HomeScreenmultbasico extends StatefulWidget {
  const HomeScreenmultbasico({super.key});

  @override
  State<HomeScreenmultbasico> createState() => _HomeScreenmultbasicoState();
}

class _HomeScreenmultbasicoState extends State<HomeScreenmultbasico> {
  var db = DBconnect4();
