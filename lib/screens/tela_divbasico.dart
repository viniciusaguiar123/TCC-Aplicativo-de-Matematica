...
import '../models/db_connect10.dart';

class HomeScreendivbasico extends StatefulWidget {
  const HomeScreendivbasico({super.key});

  @override
  State<HomeScreendivbasico> createState() => _HomeScreendivbasicoState();
}

class _HomeScreendivbasicoState extends State<HomeScreendivbasico> {
  var db = DBconnect10();
