...
import '../models/db_connect11.dart';

class HomeScreendivmedio extends StatefulWidget {
  const HomeScreendivmedio({super.key});

  @override
  State<HomeScreendivmedio> createState() => _HomeScreendivmedioState();
}

class _HomeScreendivmedioState extends State<HomeScreendivmedio> {
  var db = DBconnect11();
