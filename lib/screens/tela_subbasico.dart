...
import '../models/db_connect7.dart';

class HomeScreensubbasico extends StatefulWidget {
  const HomeScreensubbasico({super.key});

  @override
  State<HomeScreensubbasico> createState() => _HomeScreensubbasicoState();
}

class _HomeScreensubbasicoState extends State<HomeScreensubbasico> {
  var db = DBconnect7();
