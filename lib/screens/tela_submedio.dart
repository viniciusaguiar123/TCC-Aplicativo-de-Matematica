...
import '../models/db_connect8.dart';

class HomeScreensubmedio extends StatefulWidget {
  const HomeScreensubmedio({super.key});

  @override
  State<HomeScreensubmedio> createState() => _HomeScreensubmedioState();
}

class _HomeScreensubmedioState extends State<HomeScreensubmedio> {
  var db = DBconnect8();
