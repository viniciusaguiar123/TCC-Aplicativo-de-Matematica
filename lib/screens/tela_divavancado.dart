...
import 'package:matematica/widgets/result_boxdiv.dart';
...
import '../models/db_connect12.dart';

class HomeScreendivavancado extends StatefulWidget {
  const HomeScreendivavancado({super.key});

  @override
  State<HomeScreendivavancado> createState() => _HomeScreendivavancadoState();
}

class _HomeScreendivavancadoState extends State<HomeScreendivavancado> {
  var db = DBconnect12();
